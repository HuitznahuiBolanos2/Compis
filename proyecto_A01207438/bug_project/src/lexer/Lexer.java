...
public class Lexer {
	...
	public Lexer(InputStream input) {
		...
		addReserveWord(new Word("forward", Tag.FD));
		addReserveWord(new Word("fd", Tag.FD));
		addReserveWord(new Word("backward", Tag.BK));
		addReserveWord(new Word("bk", Tag.BK));
		addReserveWord(new Word("right", Tag.RT));
		addReserveWord(new Word("rt", Tag.RT));
		addReserveWord(new Word("left", Tag.LT));
		addReserveWord(new Word("lt", Tag.LT));
	}
